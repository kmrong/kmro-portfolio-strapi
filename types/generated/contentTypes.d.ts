...
export interface ApiDesignPageDesignPage extends Schema.CollectionType {
  collectionName: 'design_pages';
  info: {
    singularName: 'design-page';
    pluralName: 'design-pages';
    displayName: 'Design_page';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiDesignTileDesignTile extends Schema.CollectionType {
  collectionName: 'design_tiles';
  info: {
    singularName: 'design-tile';
    pluralName: 'design-tiles';
    displayName: 'Design_tiles';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiResearchPageResearchPage extends Schema.CollectionType {
...
export interface ApiResearchTileResearchTile extends Schema.CollectionType {
  collectionName: 'research_tiles';
  info: {
    singularName: 'research-tile';
    pluralName: 'research-tiles';
    displayName: 'Research_tiles';
    description: '';
  };
  options: {
    draftAndPublish: true;
